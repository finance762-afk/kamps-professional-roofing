...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914927-470057340_122125694816552346_3172886313220324016_n.jpg');">
...
<section class="closing-cta">
  <div class="container">
    <h2>Get a Free Slate Roofing Estimate in Grand Rapids</h2>
    <p>$20,000-$50,000+ installed. Structural assessment included at no charge. Daniel Kamps — one of the few West Michigan contractors with genuine slate installation expertise.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Schedule My Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
