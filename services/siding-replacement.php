...
<!-- INNER HERO — CTA #1 -->
<section class="inner-hero" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914928-486236482_122145997436552346_1214156033352548099_n.jpg');">
  <div class="hero-overlay"></div>
  <div class="container">
    <div class="hero-content">
      <span class="hero-eyebrow">Kamps Professional Roofing</span>
      <h1>Siding Replacement Grand Rapids, MI</h1>
      <p class="hero-subtitle">Full siding replacement with complete substrate inspection — the opportunity to fix hidden moisture damage, upgrade your energy performance, and choose a material built for Michigan's climate. Free estimates with full cost breakdown.</p>
...
<div class="ticker-strip" aria-hidden="true">
  <div class="ticker-track">
    <span>Substrate Inspection Included</span><span>★★★★★</span><span>Vinyl | Fiber Cement | Wood</span><span>Energy Upgrade Options</span><span>Grand Rapids, MI</span><span>30+ Years Experience</span><span>Free Estimates</span><span>★★★★★</span>
    <span>Substrate Inspection Included</span><span>★★★★★</span><span>Vinyl | Fiber Cement | Wood</span><span>Energy Upgrade Options</span><span>Grand Rapids, MI</span><span>30+ Years Experience</span><span>Free Estimates</span><span>★★★★★</span>
  </div>
</div>
  ...
  <div class="container">
    <div class="about-split" data-animate>
      <div class="about-content">
        ...
        <p>Siding replacement is different from repair in one important way: when all the existing panels come off, everything underneath is visible for the first time in years. Kamps performs a complete inspection of the sheathing, framing at windows and doors, and any wall penetrations during this phase. Hidden moisture damage — from years of leaking windows, improper flashing, or siding that was installed without house wrap — is only catchable at this point. Addressing it at replacement time costs a fraction of what structural repairs cost once the problem progresses another decade.</p>
        <p>Replacement is also the opportunity to upgrade your wall's thermal performance. Grand Rapids winters average over 130 heating degree days per month in January — older homes with minimal wall insulation benefit measurably from insulated vinyl siding with foam backing (R-2.5 to R-5 added to the wall assembly) or from the thermal mass and tight installation of fiber cement. This energy improvement is impossible without full siding removal, which is why homeowners who are already investing in replacement often add this upgrade at modest incremental cost.</p>
        <p>Signs that replacement rather than repair is the right call: curling or buckling across multiple wall elevations, widespread fading or color inconsistency that can't be corrected cosmetically, multiple failing sections that indicate systemic failure of the underlying house wrap, and visible rot at corners or window trim. Kamps will tell you honestly where your siding falls on the repair-to-replacement spectrum.</p>
        <p style="font-size: 0.8rem; color: var(--color-gray);">Last Updated: April 2026</p>
      </div>
      <div class="about-image">
        <picture>
          <img
            src="https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914928-486236482_122145997436552346_1214156033352548099_n.jpg"
            alt="complete siding replacement project on a Grand Rapids Michigan home"
            width="600"
            height="450"
            loading="lazy"
        ...
        <div class="stat-overlay">
          ...
          <div class="label">Years of Installs</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="why-grid">
      <div class="why-item" data-animate>
        <div class="why-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        </div>
        <div>
      ...
      <div class="why-item" data-animate>
        <div class="why-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2L2 7l10 5 10-5-10-5z"></path><path d="M2 17l10 5 10-5M2 12l10 5 10-5"></path></svg>
        </div>
        <div>
  ...
  <div class="container">
    ...
    <div class="faq-grid">
      <div class="faq-item" data-animate>
        ...
        <p>Repair makes sense for isolated damage — a few hail-damaged panels, a single cracked section. Replacement is the better financial decision when siding is curling, buckling, or fading across large areas, when multiple sections are failing systemically, when there's evidence of moisture getting behind the siding at multiple points, or when the siding is 30+ years old and the profile is no longer manufactured for matching. Kamps will assess and give you a direct recommendation — not a push toward the more expensive option if repair is genuinely adequate.</p>
      </div>
      <div class="faq-item" data-animate>
        <h3>What siding material lasts longest in Michigan?</h3>
        <p><strong>James Hardie fiber cement</strong> has the longest service life of any mainstream siding material in Michigan — 30–50 years with proper painting maintenance. It doesn't contract and expand with freeze-thaw cycles, resists moisture, and is impact-resistant against hail. High-quality vinyl lasts 20–30 years with minimal maintenance. Wood siding can last 30–40 years with diligent painting and sealing — but Michigan's wet seasons and freeze-thaw cycles demand that maintenance discipline. Neglected wood siding in Grand Rapids deteriorates faster than almost anywhere else in the region.</p>
      </div>
      <div class="faq-item" data-animate>
        <h3>How does new siding affect home value?</h3>
        <p>According to national remodeling value reports, siding replacement consistently returns <strong>70–80% of project cost</strong> in resale value — one of the better return percentages for exterior projects. In Grand Rapids' active real estate market, updated siding also shortens time-on-market and removes a potential negotiating point for buyers who would otherwise use worn siding as leverage in price discussions. Energy-efficient siding with improved R-value can also improve energy audit ratings relevant to buyers financing with efficiency-focused mortgages.</p>
      </div>
      <div class="faq-item" data-animate>
        <h3>What is fiber cement siding?</h3>
        <p><strong>Fiber cement siding</strong> is a composite material made from cement, sand, and cellulose fibers. James Hardie is the dominant brand and the one Kamps installs. Unlike vinyl, fiber cement doesn't expand and contract significantly with temperature changes, can be painted any color and recoated every 15–20 years, and is largely impervious to moisture, rot, and impact from hail. It's heavier than vinyl — installation takes longer and requires more labor — which is reflected in its higher project cost. For Grand Rapids homeowners who want a permanent exterior solution with minimal ongoing maintenance, it's the material Kamps recommends most often.</p>
      </div>
    </div>
  </div>
</section>
...
<section style="background: var(--color-dark); padding: 5rem 0;">
  <div class="container" style="text-align: center;">
    <h2 style="color: white; margin-bottom: 1rem;">Replace Your Siding Right — Substrate, Wrap, and All</h2>
    <p style="color: rgba(255,255,255,0.8); max-width: 600px; margin: 0 auto 2rem;">Don't put new panels over old problems. Get a free written estimate from Kamps that covers everything — materials, substrate inspection, house wrap, and installation — before you commit to anything.</p>
    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
      <a href="/contact" class="btn btn-accent btn-lg">Get a Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
