...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914927-473337168_122132719052552346_6134934250438671592_n.jpg');">
...
<section class="closing-cta">
  <div class="container">
    <h2>Gutters That Handle West Michigan Rain — Installed Right the First Time</h2>
    <p>Don't let undersized or failing gutters route water toward your foundation. Get a free written estimate from Kamps and know the full cost before any work starts.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Get a Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
