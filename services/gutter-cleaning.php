...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914927-481269628_122142156398552346_3436541066417212894_n.jpg');">
...
<section class="closing-cta">
  <div class="container">
    <h2>Clogged Gutters Are the Leading Cause of Preventable Fascia Rot in Grand Rapids</h2>
    <p>Schedule your spring or fall cleaning with Kamps before the seasonal slots fill. A $150 cleaning is significantly cheaper than the fascia repair it prevents.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Schedule a Cleaning</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
