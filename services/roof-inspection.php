...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914925-2023-05-26.webp');">
...
<section class="closing-cta">
  <div class="container">
    <h2>Make Your Next Roofing Decision Based on Facts, Not Guesses</h2>
    <p>A $150 written inspection report gives you documented clarity on the single most expensive component of your home's exterior. Reach out to schedule yours across the Grand Rapids area.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Schedule an Inspection</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
