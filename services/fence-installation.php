...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914928-504378959_122166753128552346_2175380586993374092_n.jpg');">
...
<section class="closing-cta">
  <div class="container">
    <h2>A Fence That Handles Grand Rapids Winters — Set Deep, Permitted Right, Built to Last</h2>
    <p>Don't pay twice for a fence installed without frost-line depth. Get a free written estimate from Kamps and have the permit research handled before a single hole is dug.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Get a Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
