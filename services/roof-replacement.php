...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914926-2025-06-27.webp');">
...
<section class="closing-cta">
  <div class="container">
    <h2>Your Roof Protects Everything Underneath It</h2>
    <p>Don't wait for a small issue to become a structural one. Get a free, no-pressure estimate from Daniel Kamps and know exactly what your replacement will cost before committing to anything.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Get a Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
