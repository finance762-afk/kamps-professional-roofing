...
<!-- Hero — CTA #1 -->
<section class="hero hero-inner" style="background-image: url('https://db.pageone.cloud/storage/v1/object/public/client-assets/kamps-professional-roofing/photos/1776176914928-482030788_122142156290552346_7963231092693514916_n.jpg');">
  <div class="hero-overlay"></div>
  <div class="container">
    <div class="hero-content">
      <span class="hero-eyebrow">Kamps Professional Roofing</span>
      <h1>Siding Installation Grand Rapids, MI</h1>
      <p class="hero-subtitle">Vinyl, James Hardie fiber cement, and wood siding installed with proper house wrap and water management — not just new panels over the same moisture problems. 30+ years of West Michigan exterior work.</p>
    ...
    <div class="why-grid">
      ...
      <div class="why-item" data-animate>
        ...
        <div>
          ...
          <p>Not every siding profile sold in Grand Rapids is appropriate for this climate. Kamps specifies products with performance records in Zone 5 climates — freeze-thaw tested, wind-rated for West Michigan's lakeshore exposure, and matched to your home's sun and moisture exposure.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="process-grid">
      ...
      <div class="process-step" data-animate>
        ...
        <p>Existing siding removed and disposed of. Substrate inspected for rot or moisture damage. Any compromised material is replaced before the water barrier layer is applied.</p>
      </div>
      <div class="process-step" data-animate>
...
<section class="closing-cta">
  <div class="container">
    <h2>New Siding That Keeps Michigan Weather Where It Belongs — Outside</h2>
    <p>Whether you're replacing worn vinyl or upgrading to fiber cement, get a free written estimate from Kamps with material costs, labor, and everything else broken out line by line.</p>
    <div class="btn-row">
      <a href="/contact" class="btn btn-accent btn-lg">Get a Free Estimate</a>
      <?php echo phone_link('btn btn-outline-white btn-lg'); ?>
    </div>
