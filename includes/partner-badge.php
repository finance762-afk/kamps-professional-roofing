 ...
 */
$ppSlug = isset($partnerProfileSlug) && $partnerProfileSlug !== '' ? (string) $partnerProfileSlug : 'kamps-professional-roofing-grand-rapids-mi';
$ppName = isset($partnerProfileName) && $partnerProfileName !== '' ? (string) $partnerProfileName : 'Kamps Professional Roofing';
